...
resource "google_compute_instance_template" "default" { 
  ...
  disk {
    ...
    mode         = "READ_WRITE"
    source_image = "projects/core-rhythm-279909/global/images/image-production-0-202301051650"
    type         = "PERSISTENT"
  }
  labels = {
  ...
  metadata = {
    startup-script = <<EOF
    #! /bin/bash
    git clone ssh://youdig@favinet.co.kr@source.developers.google.com:2022/p/touchad-ce3d1/r/github_favinet_test01
    cd github_favinet_test01
    npm install
    npm start
    EOF
  }
